...
- [ ] 02-02-PLAN.md — Tunnel up: PUSH_REQUEST/PUSH_REPLY, tunnel-IP pool, `Session.AssignedIP()`, `OnSession` moves past tunnel-up

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 02-03-PLAN.md — AES-256-GCM data channel (`internal/datachan`), peer-id demux, replay window, ping absorption, real `Session.Read`/`Write`
