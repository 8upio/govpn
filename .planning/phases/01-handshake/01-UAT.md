...
number: 1
name: Real CI execution of the interop GitHub Actions job
expected: |
...
expected: A client that stalls mid-handshake is torn down after reliable.HandshakeWindow (60s) — enforceHandshakeWindow (ovpn.go:404) is wired but the timeout-triggered teardown path has no test (time.After is not clock-injectable).
result: [pending]
